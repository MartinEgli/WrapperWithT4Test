...
{
	public class AlarmSvcProxy : IAlarmSvcProxy, System.IDisposable
	{
		protected Siemens.Sinumerik.Operate.Services.AlarmSvc _inner;

		#region Constructors
							public AlarmSvcProxy()
			{
				_inner = new Siemens.Sinumerik.Operate.Services.AlarmSvc();
							}
							public AlarmSvcProxy(System.String language)
			{
				_inner = new Siemens.Sinumerik.Operate.Services.AlarmSvc(language);
							}
							public AlarmSvcProxy(System.String language, System.String server)
			{
				_inner = new Siemens.Sinumerik.Operate.Services.AlarmSvc(language, server);
							}
							public AlarmSvcProxy(System.String language, System.String server, System.Int32 eventlistLength)
			{
	...
	public interface IAlarmSvcProxy
	{
		#region Events
				#endregion
	...
	public interface IAlarmSvcProxyFactory
	{
		IAlarmSvcProxy Create(params object[] args);
		IAlarmSvcProxy Create();
		IAlarmSvcProxy Create(System.String language);
		IAlarmSvcProxy Create(System.String language, System.String server);
		IAlarmSvcProxy Create(System.String language, System.String server, System.Int32 eventlistLength);
	}

	public class AlarmSvcProxyFactory : IAlarmSvcProxyFactory
	{
		public virtual IAlarmSvcProxy Create(params object[] args)
		{
			return (IAlarmSvcProxy)System.Activator.CreateInstance(typeof(AlarmSvcProxy), args);
		}

		public virtual IAlarmSvcProxy Create()
		{
			return new AlarmSvcProxy(); 
		}

		public virtual IAlarmSvcProxy Create(System.String language)
		{
			return new AlarmSvcProxy(language); 
		}

		public virtual IAlarmSvcProxy Create(System.String language, System.String server)
		{
			return new AlarmSvcProxy(language, server); 
		}

		public virtual IAlarmSvcProxy Create(System.String language, System.String server, System.Int32 eventlistLength)
		{
			return new AlarmSvcProxy(language, server, eventlistLength); 
		}
